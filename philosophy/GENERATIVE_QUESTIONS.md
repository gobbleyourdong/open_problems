...
| 4 | [what_is_self](./what_is_self/) | Phase 2 + Lean (6 thm, 0 sorry) | Identity=continuity (Parfit r=+0.759); felt selfhood=transparency (Metzinger r=+0.972); γ load path proven | **Two sub-questions both answered; T separates human from LLM selfhood (6.1×); parfitCompatibleIffGammaCompatible proven; 3 predictions** |
| 5 | [what_is_knowing](./what_is_knowing/) | Phase 2 + Lean (8 thm) | 81% of A-knowing reduces to compression; virtue epistemology residual characterized; depth/breadth tradeoff confirmed | **r(depth,advantage)=+0.972; r(density,accuracy)=+0.986; 7/8 post-Gettier conditions reduce; internalism=γ-epistemology; Reid confirmed** |
...
| 7 | [what_is_life](./what_is_life/) | Phase 2 + Lean (9 thm) | 6-dim demarcation; life-mind independence (LLM proof); γ gradient: consciousness tracks G×L×T not life | **r=+0.906; G×L×T>neurons for consciousness; welfare salience tracks consciousness gradient; six ontologies unified** |
| 8 | [what_is_good](./what_is_good/) | Phase 4 (mapped) + 4 Lean (23 thm, 0 sorry) | Fully mapped: Pareto core solved (91%), aggregation frontier irreducible (Arrow), moral traditions ≈ Arrow subsets, Gödel-Arrow parallel | **6/10 predictions confirmed; frontier proven irreducible; 5 attempts, 6 results, 5 numerics** |
