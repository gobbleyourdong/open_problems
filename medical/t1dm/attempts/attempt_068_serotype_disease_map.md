...
### For the operator
If the operator's T1DM was triggered by CVB, it was most likely **CVB4** (tropism score 0.90 for T1DM). CVB4-specific neutralizing antibodies, if measured, would confirm the serotype.
...
**the operator could have been infected by multiple serotypes over their lifetime.** This would explain multi-organ vulnerability even with a T1DM-dominant presentation.
