...
- Current dose: 2 units Humalog per meal (~6-8 units/day total)
- Already doing 18:6 IF (6-hour eating window)
- Eating 15-20g carbs per meal
...
```
On keto:    Demand = very low.  Supply (remaining beta cells) ≥ Demand. → No insulin needed.
On carbs:   Demand = moderate.  Supply < Demand by ~20%. → 6-8 units fills the gap.
```
...
- 18 hours of autophagy activation daily
- Daily AMPK activation
- Daily mTOR cycling (off during fast, on during feeding window)
...
- Autoantibody panel (which antigens — GAD, IA-2, ZnT8?)
- Enteroviral markers (VP1, IFN-α — is CVB persisting?)
- Vitamin D level (likely low, easy fix)
- Fasting insulin + glucose (calculate HOMA-B, HOMA-IR)
- HbA1c (current control baseline)

### Stage 1: Low-Hanging Fruit (Weeks 2-6)
Already partially done. Intensify:
- **Vitamin D**: load to 60 ng/mL (immunomodulatory dose)
- **GABA**: 750mg twice daily ($15/mo) — alpha-to-beta conversion + anti-inflammatory + beta cell survival
- **Butyrate**: 300mg sodium butyrate daily OR 2 tbsp resistant starch (cooled potatoes, oats) — FOXP3 derepression → Tregs
- **Omega-3**: 2g EPA+DHA daily (anti-inflammatory)
- If CVB+: **Fluoxetine** 20mg daily (antiviral, $10/mo — discuss with doctor re: mental health considerations)
- Continue 18:6 IF
- Continue moderate carbs (15-20g/meal is actually reasonable — not too high)

**Cost: ~$60/month. No prescription needed except fluoxetine.**

### Stage 2: FMD Intensification (Months 2-8)
Upgrade from daily 18:6 IF to monthly 5-day FMD:
- One 5-day FMD per month (750 kcal days 2-5, high fat low protein low carb)
- Insulin adjustment during FMD: likely reduce to 0-1 units/meal (with CGM monitoring)
- During refeeding (days 6-8): emphasize high-fiber, fermented foods (butyrate burst)
- Optional: semaglutide 0.25mg weekly (GLP-1 for beta cell boost — requires prescription)
- Continue GABA, butyrate, vitamin D, omega-3 throughout
- **Monthly C-peptide check to track progress**

**Cost: ~$100-400/month depending on semaglutide access.**

### Stage 2 Decision (Month 8)
- C-peptide rising, insulin needs dropping → continue maintenance
- C-peptide stable → add teplizumab course (bigger immune reset, ~$200K)
- C-peptide declining → reassess, consider full protocol

### Stage 4: Maintenance
- Quarterly 5-day FMD (or continue daily 18:6 IF — whichever is sustainable)
- GABA, butyrate, vitamin D, omega-3 ongoing
...
Option 3 is the easiest. Option 1 is the most durable. Both together: insulin independence with normal carb intake.

## The Cheapest Path to Insulin Independence

```
Month 0:  Bloodwork ($500)
Month 1+: GABA + butyrate + vitamin D + omega-3 ($60/mo)
Month 2+: Monthly FMD cycles ($0 — just don't eat for 5 days)
          + continue 18:6 IF between cycles
          + CGM monitoring (already have)
Ongoing:  Track C-peptide monthly
