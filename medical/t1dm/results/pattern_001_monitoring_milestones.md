...
systematic approach -- numerical track (numerics) -- Clinical Bridge
Date: 2026-04-08
...
**the patient context:** Diagnosed 12/2019 with C-peptide (residual) ng/mL (~0.30 nmol/L). Achieved 5-year insulin independence on keto, suggesting significant residual beta cell mass. Current estimate: fasting C-peptide 0.15-0.25 nmol/L (needs measurement to confirm).
