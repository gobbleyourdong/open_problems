...
|---|-------------|-------|------------|
| Y113 | THEWALL L233 | "LL-37 rebound → direct TRPV1 agonist (Buhl 2017 J Allergy Clin Immunol)" | **2026-04-20 CROSS-AUDIT CONVERGENCE — RESOLVED AS FM1c FABRICATION**. Y113's prior "needs confirmation" hedge is now confirmed as fabrication via independent dysbiosis Fires 82+88+89 (`medical/dysbiosis/VERIFIED_REFS.md`). Three distinct "Buhl 2017" journal attributions exist across the corpus (this one *J Allergy Clin Immunol*; dysbiosis run_068 *Exp Dermatol* calprotectin; dysbiosis run_093 *J Invest Dermatol* TRPA1) — none verified. Inline PMID 27840092 (from dysbiosis run_015) also returns no Buhl LL-37/TRPV1 paper. The single real Buhl T paper is **Buhl 2015 *JID* PMID 25848978** (Th1/Th17 transcriptome) which contains none of the three fabricated mechanisms. Two independent audits (POD Y113 and dysbiosis Phase 4b) converging on the same retraction = sigma v9.1 cross-audit triangulation signal. |
