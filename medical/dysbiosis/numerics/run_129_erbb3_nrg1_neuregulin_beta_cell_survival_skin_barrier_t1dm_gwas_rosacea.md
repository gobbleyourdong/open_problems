...
2. **MODERATE evidence**:
   - T1DM: HIGH — ERBB3 rs2292239 is among the first replicated non-HLA T1DM GWAS hits (Hakonarson 2007 NEJM; first T1DM GWAS study, Hakonarson 2007 NEJM top findings; Cooper 2008 Nat Genet PMID 18978792 confirmation [year corrected per VERIFIED_REFS Fire 86 — was previously cited as "Cooper 2012"]); NRG1 (heregulin) protects human β cells and islet lines from cytokine-induced apoptosis (Lackey 1999 Diabetes; Huotari 1998 Mol Endocrinol; Schiesser 2017 Diabetes) ✓
