...
**Date:** 2026-04-12
**Framework position:** RASGRP1 (RAS guanyl nucleotide-releasing protein 1) completely absent from all 138 prior runs. The PLCγ → DAG branch of antigen receptor signaling has been analyzed ONLY for IP3 arm (ITPR3/STIM1/ORAI1/NFAT, runs 132/127/125) and PKC/NF-κB arm (multiple runs). The DAG → RASGRP1 → RAS → ERK branch — the third major output of DAG — has never been analyzed. 13th mast cell mechanism (RASGRP1 → ERK = cytokine/transcription arm distinct from Ca²⁺/degranulation arm); 14th T1DM genetic stratification (rs17574546, Cooper 2012 Nat Genet).
